"""Settings panel for Justworks Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__justworks_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=justworks_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_justworks"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Justworks Settings & Accounts", level=2),
