"""Pydantic schemas for Justworks Connector (C28. Payroll & Benefits Administration)."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Acme Justworks.")
