# Plausible Scenario Tests (PST) — Justworks Connector
...
- `connect_justworks`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_justworks`: validated contract & error handling
